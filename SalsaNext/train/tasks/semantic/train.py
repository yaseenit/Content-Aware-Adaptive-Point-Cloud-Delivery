...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        type=bool,
        default=False,
        help='If you want to use a run name without timestamp'
    )
    parser.add_argument(
        '--pretrained', '-p',
        type=str,
    ...
    parser.add_argument(
        '--class_difference_loss', '-cdl',
        type=str,
        required=False,
        choices=['mae', 'iou', 'me', 'me-relu'],
        default=None,
        help='Set this if you want to use the class difference loss'
    )
    parser.add_argument(
        '--disable_wce',
        type=bool,
        default=False,
        help='Set this if you want to train without the wce loss'
    )
    FLAGS, unparsed = parser.parse_known_args()

    run_name = FLAGS.name
    if not FLAGS.nameWithoutTimestamp:
        run_name = datetime.datetime.now().strftime("%Y-%-m-%d-%H:%M") + run_name
    FLAGS.log = FLAGS.log + '/logs/' + run_name
    ...
    print("wce loss", not FLAGS.disable_wce)
    print("----------\n")
    ...
    trainer = Trainer(ARCH, DATA, FLAGS.dataset, FLAGS.log, FLAGS.pretrained,FLAGS.uncertainty, class_difference_loss=FLAGS.class_difference_loss, disable_wce=FLAGS.disable_wce)
    trainer.train()
